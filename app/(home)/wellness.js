...
const quizData = [
  {
    question: 'What brain chemical is known as the "happiness neurotransmitter"?',
  ...
  {
    question: 'How long can your brain hold information in short-term memory without rehearsal?',
  ...
  {
    question: 'Which color is scientifically proven to reduce stress and anxiety?',
  ...
  {
    question: 'What percentage of your dreams do you typically forget by morning?',
    options: ['25%', '50%', '75%', '95%'],
  ...
  {
    question: "What's the name for your body's automatic 'fight or flight' response?",
    options: [
  ...
  {
    question: "Your brain uses approximately what percentage of your body's total energy?",
    options: ['5%', '20%', '35%', '50%'],
    correctAnswerIndex: 1,
    funFact:
  ...
  {
    question: 'Practicing gratitude for just 2 weeks can increase happiness by how much?',
    options: ['5%', '25%', '50%', '75%'],
    correctAnswerIndex: 1,
    funFact:
        ...
        {current.options.map((option, index) => {
          ...
          return (
            <TouchableOpacity
              ...
              style={[
                styles.option,
                isCorrect && showAnswer ? styles.correct : isWrong ? styles.wrong : null,
              ]}
